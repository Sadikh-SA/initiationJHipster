package sn.sa.devweb.config.timezone;

import sn.sa.devweb.InitiationJHipsterApp;
import sn.sa.devweb.repository.timezone.DateTimeWrapper;
import sn.sa.devweb.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = InitiationJHipsterApp.class)
